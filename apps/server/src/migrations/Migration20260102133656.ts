...
export class Migration20260102133656 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(
      `create table "verification" ("id" uuid not null default gen_random_uuid(), "created_at" timestamptz not null, "updated_at" timestamptz not null, "identifier" varchar(255) not null, "value" varchar(255) not null, "expires_at" timestamptz not null, constraint "verification_pkey" primary key ("id"));`,
    );
  }
