...
const H1 = ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
  <h1 className={cn(typographyVariants({ level: "h1" }), className)} {...props} />
)

const H2 = ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
  <h2 className={cn(typographyVariants({ level: "h2" }), className)} {...props} />
)

const H3 = ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
  <h3 className={cn(typographyVariants({ level: "h3" }), className)} {...props} />
)

const H4 = ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
  <h4 className={cn(typographyVariants({ level: "h4" }), className)} {...props} />
)

const H5 = ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
  <h5 className={cn(typographyVariants({ level: "h5" }), className)} {...props} />
)

const P = ({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) => (
  <p className={cn(typographyVariants({ level: "p", tone: "muted" }), className)} {...props} />
)

const Text = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => (
  <span className={cn(typographyVariants({ level: "text" }), className)} {...props} />
)
